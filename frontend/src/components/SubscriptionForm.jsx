...
      setSuccessMessage("Request sent! Check your email to confirm."); // ¡Petición enviada! Revisa tu correo para confirmar.
      // Reset form
      setFormData({
        email: "",
        phone: "",
...
        <h2 className="overpass-bold">Do you want to receive alerts?</h2> {/* ¿Quieres recibir avisos? */}
      </div>
      <div className="text-center mb-8 md:mb-12 text-xl text-gray-400">
        <h3 className="overpass-medium">
          We will send you an email to confirm your subscription. {/* Te enviaremos un correo para confirmar tu suscripción. */}
        </h3>
        <p>
          And you will be notified when there are new pollution alerts in your city. {/* Y serás notificado cuando haya nuevas alertas de contaminación en tu ciudad. */}
        </p>
      </div>
