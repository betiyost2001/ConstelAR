...
import { getPollutantLongLabel } from "../constants/pollutants";
    ...
    >
      <VStack spacing={3} align="flex-start">
        ...
        <Heading as="h3" size="lg" color="white">
          {t("pollutantsPage.pollutants." + id + ".label")}{" "}
          <Badge
            ml={1}
            colorScheme="teal"
            variant="solid"
        ...
        <Stack spacing={2} mt={3} fontSize="sm">
          <Text color="whiteAlpha.800">
            <b style={{ color: ACCENT_COLOR }}>
              {t("pollutantsPage.whatMeasures")}
            </b>{" "}
            {t("pollutantsPage.pollutants." + id + ".measures")}
          </Text>
          <Text color="whiteAlpha.800">
            <b style={{ color: ACCENT_COLOR }}>{t("pollutantsPage.sources")}</b>{" "}
            {t("pollutantsPage.pollutants." + id + ".sources")}
          </Text>
          <Text color="whiteAlpha.800">
            <b style={{ color: ACCENT_COLOR }}>{t("pollutantsPage.risks")}</b>{" "}
            {t("pollutantsPage.pollutants." + id + ".risks")}
          </Text>
          <Text color="whiteAlpha.800">
            <b style={{ color: ACCENT_COLOR }}>
              {t("pollutantsPage.goodPractices")}
            </b>{" "}
            {t("pollutantsPage.pollutants." + id + ".tips")}
          </Text>
        </Stack>
      </VStack>
    </Box>
      ...
      <VStack spacing={10} align="stretch">
        <VStack spacing={2} textAlign="center" mb={6}>
          <Heading as="h1" size="2xl" color="white">
            {t("pollutantsPage.title")}
          </Heading>
          <Text color="whiteAlpha.700" fontSize="lg">
            {t("pollutantsPage.subtitle")}
          </Text>
        </VStack>
